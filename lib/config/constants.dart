...
class GameColors {
  ...
  static const Color secondary = Color(0xFFF76B8A);
  static const Color accent = Color(0xFF34B3F1);
  static const Color success = Color(0xFF8C52FF);
  static const Color warning = Color(0xFFFDBE51);
